...
{
    data.map(i=> (
        <div key={i._id} className="mt min-h-screen">
...
<Link to={`/detailscard/${i._id}`}><button className="w-full mt-3 text-white bg-[#2563eb] py-3 rounded-md hover:bg-[#4074e5]">View Details</button></Link>
</div>
</div>
    ))
}
