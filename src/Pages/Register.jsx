...
const Register = () => {
    ...
    const handleRegister = e =>{
        ...
        const results ={name,email,password,photo}
        console.log(results)
      
        if (password.length < 6) {
            toast.error("password must be at least 6 characters or long")
            return;
        }
      ...
      <div className="grid md:grid-cols-2 items-center gap-8 h-full">
        ...
        <div className="flex items-center md:p-8 p-6 bg-[#0C172C] h-full lg:w-11/12 lg:ml-auto">
          ...
          <form onSubmit={handleRegister} className="max-w-lg w-full mx-auto">
            ...
            <div className="mt-12">
              <input type="submit" value="register" className="w-max shadow-xl py-2.5 px-8 text-sm font-semibold rounded-md bg-transparent text-yellow-400 border border-yellow-400 focus:outline-none" />
